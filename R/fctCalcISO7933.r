...
# Dlimloss50 -
# Dlimloss95 -
# Cres       - konvektiver Wärmefluss bei der Atmung? W/m2
# Ep         - vorhergesagter Wärmefluss durch Verdunstung
# SWp		 - vorhergesagte Schweißrate
# Texp	 - Temperatur der ausgeatmeten Luft
# Tskeq	 - mittlere Hauttemperatur im stabilen Zustand
# wp		 - 
#
# File contains 1 function:
#   - function(THETA, weight, height, Duration, DRINK, Adu, spHeat, SWp, SWtot, Tre, Tcr, Tsk, Tcreq, Ta, Tr, Pa, Va, Met, Work, posture, Icl, imst, Ap, Fr, defspeed, Walksp, defdir, accl, HR, pb)
#       returns a data.frame with Tre, SWtotg, Dlimtre, Dlimloss50, Dlimloss95
#
...
fctCalcIso7933 <- function(THETA, weight, height, Duration, DRINK, Adu, spHeat, SWp, SWtot, Tre, Tcr, Tsk, Tcreq, Ta, Tr, Pa, Va, Met, Work, posture, Icl, imst, Ap, Fr, defspeed, Walksp, defdir, accl, HR, pb){
...
if(missing(SWtot)){
	SWtot = 0
	warning("SWtot set to default 0")
}
...
data.frame(Tre,SWtotg,Dlimtre,Dlimloss50,Dlimloss95,Cres,Ep,SWp,Texp,Tskeq,wp)
